...
export async function POST(req: NextRequest) {
  try {
    ...
    // Buat order dengan status MENUNGGU_PEMBAYARAN dulu (stok BELUM dikurangi di sini —
    // stok baru dikurangi saat webhook konfirmasi LUNAS masuk, lihat /api/webhooks/xendit)
